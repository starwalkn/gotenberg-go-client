...
|:----------------:|:---------------------------------------------------------------------------------------------------------:|
|`8.x` **(actual)**|`>= 8.6.0-beta` **(beta-release)**, `<= 8.5.0` **(non-full compilant)**                                    |                            
|`7.x`             |`<= 8.5.0`                                                                                                 |
...
> [!TIP]
> Head to the [documentation](https://gotenberg.dev/) to learn about all request parameters. For the PaperSize method, you can use predefined parameters such as gotenberg.A4, gotenberg.A3 and so on. The full list of predefined parameters can be found in gotenberg-go-client/types.go
